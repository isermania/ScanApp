...
/*
    ...
    protected void launchEnrollRecipient()
    {
        ...
        Intent i2 = new Intent(UareUSampleJava.this, EnrollmentActivity.class);
        i2.putExtra("device_name", m_deviceName);
	...
	protected void CheckDevice()
	{
		try
		{
			...
			setButtonsEnabled_Capture(true);
			m_reader.Close();
		} 
