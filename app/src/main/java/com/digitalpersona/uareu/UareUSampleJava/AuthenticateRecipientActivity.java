...
/**
 * Created by Corbeau on 5/2/2018.
 */
...
public class AuthenticateRecipientActivity extends Activity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        if (nSize > 1)
        {
            ...
            m_readers.setOnItemClickListener(new AdapterView.OnItemClickListener()
            {
